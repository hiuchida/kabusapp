...
public class MainPositions_r1 {
	 ...
	 */
	private static final String TXT_FILEPATH = DIRPATH + "MainPositions_r1.txt";
	/**
	 * 建玉情報ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "MainPositions_r1.log";
