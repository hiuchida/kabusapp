 ...
 * 新規注文情報を管理する。
 */
public class EntryOrdersLogic_r6 {
	 ...
	 */
	private static final String TXT_FILEPATH = DIRPATH + "EntryOrdersLogic_r6.txt";
	/**
	 * 新規注文情報の削除情報を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String DEL_FILEPATH = DIRPATH + "EntryOrdersLogic_r6.del";
	/**
	 * 新規注文ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "EntryOrdersLogic_r6.log";
	 ...
	 */
	public EntryOrdersLogic_r6(String X_API_KEY) {
	...
	public void readOrders() {
		...
		System.out.println("EntryOrdersLogic_r6.readOrders(): orderMap.size=" + orderMap.size());
	...
	private void deleteOrders() {
		...
		if (orderKeySet.size() > 0) {
			System.out.println("EntryOrdersLogic_r6.deleteOrders(): orderKeySet.size=" + orderKeySet.size());
		...
		if (delList.size() > 0) {
			try (PrintWriter pw = FileUtil.writer(DEL_FILEPATH, FileUtil.UTF8, true)) {
				System.out.println("EntryOrdersLogic_r6.deleteOrders(): delList.size=" + delList.size());
	...
	public void writeOrders() {
		System.out.println("EntryOrdersLogic_r6.writeOrders(): orderMap.size=" + orderMap.size());
