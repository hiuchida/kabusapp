...
import v18.EntryOrdersLogic_r6.OrderInfo;

/**
 * 新規注文ツール。
 */
public class MainEntryOrder_r6 {
	/**
	 * 銘柄コード(Symbol)。 
	 */
	 ...
	 */
	private static final String CFG_FILEPATH = DIRPATH + "MainEntryOrder_r6.cfg";
	/**
	 * 新規注文依頼情報を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String TXT_FILEPATH = DIRPATH + "MainEntryOrder_r6.txt";
	/**
	 * 新規注文ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "MainEntryOrder_r6.log";
	/**
	 * メール本文を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String MAIL_FILEPATH = DIRPATH + "MainEntryOrder_r6.mail";
	/**
	 * 新規注文依頼設定ファイルのカラム数。
	 */
	...
	public static void main(String[] args) throws ApiException {
		...
		try {
			new MainEntryOrder_r6(X_API_KEY).execute();
		} finally {
	 ...
	 * 新規注文情報を管理する。
	 */
	private EntryOrdersLogic_r6 entryOrdersLogic;
	 ...
	 */
	public MainEntryOrder_r6(String X_API_KEY) {
		this.boardLogic = new BoardLogic(X_API_KEY);
		this.entryOrdersLogic = new EntryOrdersLogic_r6(X_API_KEY);
	...
	private void readConfig() {
		...
		System.out.println("MainEntryOrder_r6.readConfig(): lines.size=" + lines.size());
		for (String s : lines) {
			if (s.length() == 0) {
				continue;
			}
	...
	private void readOrders() {
		...
		System.out.println("MainEntryOrder_r6.readOrders(): orderMap.size=" + orderMap.size());
		for (String key : orderMap.keySet()) {
	...
	private void writeOrders() {
		System.out.println("MainEntryOrder_r6.writeOrders(): orderMap.size=" + orderMap.size());
