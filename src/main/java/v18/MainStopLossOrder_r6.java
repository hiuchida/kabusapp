 ...
 * ストップロス注文ツール。
 */
public class MainStopLossOrder_r6 {
	/**
	 * API実行クラス。
	 */
	 ...
	 */
	private static final String LOG_FILEPATH = DIRPATH + "MainStopLossOrder_r6.log";
	/**
	 * メール本文を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String MAIL_FILEPATH = DIRPATH + "MainStopLossOrder_r6.mail";
	...
	public static void main(String[] args) throws ApiException {
		...
		try {
			new MainStopLossOrder_r6(X_API_KEY).execute();
		} finally {
	 ...
	 */
	public MainStopLossOrder_r6(String X_API_KEY) {
