 ...
 * トレイル注文ツール。
 */
public class MainTrailOrder_r2 {
	/**
	 * タブ文字。
	 */
	 ...
	 */
	private static final String LOG_FILEPATH = DIRPATH + "MainTrailOrder_r2.log";
	...
	public static void main(String[] args) throws ApiException {
		...
		try {
			new MainTrailOrder_r2(X_API_KEY).execute();
		} finally {
	 ...
	 * 建玉情報を管理する。
	 */
	private PositionsLogic_r2 posLogic;
	...
	private String sendCloseOrder(PosInfo pi, ExecutionInfo ei, int exchange, String holdId) throws ApiException {
		...
		String msg = "code=" + body.getSymbol() + ", exchange=" + body.getExchange() + ", price=" + pi.triggerPrice
