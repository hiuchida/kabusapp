 ...
 * 返済注文約定情報を管理する。
 */
public class CloseOrdersLogic_r2 {
	 ...
	 */
	private static final String TXT_FILEPATH = DIRPATH + "CloseOrdersLogic_r2.txt";
	/**
	 * 返済注文情報ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "CloseOrdersLogic_r2.log";
	/**
	 * 返済注文情報ファイルのカラム数。
	 */
	 ...
	 */
	public CloseOrdersLogic_r2(String X_API_KEY) {
	...
	public void execute() throws ApiException {
		...
		System.out.println("CloseOrdersLogic_r2.execute(): response.size=" + response.size());
	...
	private void readOrders() {
		...
		System.out.println("CloseOrdersLogic_r2.readOrders(): orderMap.size=" + orderMap.size());
		for (String key : orderMap.keySet()) {
			String val = orderMap.get(key);
	...
	private void deleteOrders() {
		if (orderKeySet.size() > 0) {
			System.out.println("CloseOrdersLogic_r2.deleteOrders(): orderKeySet.size=" + orderKeySet.size());
	...
	public void writeOrders() {
		System.out.println("CloseOrdersLogic_r2.writeOrders(): orderMap.size=" + orderMap.size());
