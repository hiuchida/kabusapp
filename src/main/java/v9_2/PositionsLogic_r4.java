...
public class PositionsLogic_r4 {
	 ...
	 */
	private static final String LOG_FILEPATH = DIRPATH + "PositionsLogic_r4.log";
	 ...
	 */
	public PositionsLogic_r4(String X_API_KEY) {
	...
	public List<PosInfo> execute() throws ApiException {
		...
		System.out.println("PositionsLogic_r4.execute(): response.size=" + response.size());
	...
	private void readPositions() {
		...
		System.out.println("PositionsLogic_r4.readPositions(): posMap.size=" + posMap.size());
	...
	public void writePositions() {
		...
		System.out.println("PositionsLogic_r4.writePositions(): posMap.size=" + posMap.size());
		List<PosInfo> list = new ArrayList<>();
