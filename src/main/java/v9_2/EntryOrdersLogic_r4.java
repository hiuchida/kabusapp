 ...
 * 新規注文情報を管理する。
 */
public class EntryOrdersLogic_r4 {
	 ...
	 */
	private static final String LOG_FILEPATH = DIRPATH + "EntryOrdersLogic_r4.log";
	 ...
	 */
	public EntryOrdersLogic_r4(String X_API_KEY) {
	...
	public void readOrders() {
		...
		System.out.println("EntryOrdersLogic_r4.readOrders(): orderMap.size=" + orderMap.size());
	...
	public void writeOrders() {
		System.out.println("EntryOrdersLogic_r4.writeOrders(): orderMap.size=" + orderMap.size());
