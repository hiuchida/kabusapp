 ...
 */
public class MainMergeChartData_r2 {
	/**
	 * 基準パス。
	 */
	...
	public static void main(String[] args) {
		new MainMergeChartData_r2().execute();
	}
	...
	private void read5mChartData() {
		...
		System.out.println("MainMergeChartData_r2.read5mChartData(): readCnt=" + readCnt);
	}
	...
	private void readCsvChartData() {
		...
		System.out.println("MainMergeChartData_r2.readCsvChartData(): readCnt=" + readCnt);
	}
	...
	private void writeChartMap() {
		...
		System.out.println("MainMergeChartData_r2.writeChartMap(): chartMap.size=" + chartMap.size());
