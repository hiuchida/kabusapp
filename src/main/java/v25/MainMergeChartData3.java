 ...
 */
public class MainMergeChartData3 {
	/**
	 * 基準パス。
	 */
	...
	public static void main(String[] args) {
		new MainMergeChartData3().execute();
	}
	...
	private void read5mChartData() {
		...
		System.out.println("MainMergeChartData3.read5mChartData(): readCnt=" + readCnt);
	}
	...
	private void readCsvChartData() {
		...
		System.out.println("MainMergeChartData3.readCsvChartData(): readCnt=" + readCnt);
	}
	...
	private void writeChartMap() {
		...
		System.out.println("MainMergeChartData3.writeChartMap(): chartMap.size=" + chartMap.size());
