...
public class EntryOrdersLogic_r5 {
	 ...
	 */
	private static final String TXT_FILEPATH = DIRPATH + "EntryOrdersLogic_r5.txt";
	/**
	 * 新規注文情報の削除情報を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String DEL_FILEPATH = DIRPATH + "EntryOrdersLogic_r5.del";
	/**
	 * 新規注文ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "EntryOrdersLogic_r5.log";
	 ...
	 */
	public EntryOrdersLogic_r5(String X_API_KEY) {
	...
	public List<OrderInfo> execute() throws ApiException {
		...
		System.out.println("EntryOrdersLogic_r5.execute(): response.size=" + response.size());
		posLogic.execute();
	...
	public void readOrders() {
		...
		System.out.println("EntryOrdersLogic_r5.readOrders(): orderMap.size=" + orderMap.size());
	...
	private void deleteOrders() {
		...
		if (orderKeySet.size() > 0) {
			System.out.println("EntryOrdersLogic_r5.deleteOrders(): orderKeySet.size=" + orderKeySet.size());
		...
		if (delList.size() > 0) {
			try (PrintWriter pw = FileUtil.writer(DEL_FILEPATH, FileUtil.UTF8, true)) {
				System.out.println("EntryOrdersLogic_r5.deleteOrders(): delList.size=" + delList.size());
	...
	public void writeOrders() {
		System.out.println("EntryOrdersLogic_r5.writeOrders(): orderMap.size=" + orderMap.size());
