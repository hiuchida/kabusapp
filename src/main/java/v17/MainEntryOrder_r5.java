 ...
 * 新規注文ツール。
 */
public class MainEntryOrder_r5 {
	/**
	 * 銘柄コード(Symbol)。 
	 */
	 ...
	 */
	private static final String CFG_FILEPATH = DIRPATH + "MainEntryOrder_r5.cfg";
	/**
	 * 新規注文依頼情報を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String TXT_FILEPATH = DIRPATH + "MainEntryOrder_r5.txt";
	/**
	 * 新規注文ログのファイルパス。存在しなければ生成される。
	 */
	private static final String LOG_FILEPATH = DIRPATH + "MainEntryOrder_r5.log";
	/**
	 * メール本文を保存したファイルパス。存在しなければ生成される。
	 */
	private static final String MAIL_FILEPATH = DIRPATH + "MainEntryOrder_r5.mail";
	/**
	 * 新規注文依頼設定ファイルのカラム数。
	 */
	 ...
	 * 新規注文情報を管理する。
	 */
	private EntryOrdersLogic_r5 entryOrdersLogic;
	...
	private void readConfig() {
		...
		System.out.println("MainEntryOrder_r5.readConfig(): lines.size=" + lines.size());
		for (String s : lines) {
			if (s.length() == 0) {
				continue;
			}
	...
	private void readOrders() {
		...
		System.out.println("MainEntryOrder_r5.readOrders(): orderMap.size=" + orderMap.size());
		for (String key : orderMap.keySet()) {
	...
	private void writeOrders() {
		System.out.println("MainEntryOrder_r5.writeOrders(): orderMap.size=" + orderMap.size());
