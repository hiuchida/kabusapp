 ...
 */
public class LockedAuthorizedToken_r3 {
	/**
	 * 基準パス。
	 */
	 ...
	 * シングルトンインスタンス。
	 */
	private static LockedAuthorizedToken_r3 singleton = new LockedAuthorizedToken_r3();
	/**
	 * ファイルロック情報。
	 */
	 ...
	 * @return シングルトンインスタンス。
	 */
	public static LockedAuthorizedToken_r3 getInstance() {
		return singleton;
	}
	...
	private LockedAuthorizedToken_r3() {
	}
